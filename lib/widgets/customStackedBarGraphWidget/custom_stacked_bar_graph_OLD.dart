...
//         child: Padding(
//         padding: const EdgeInsets.only(left: 55, bottom: 40, top: 20), // Add some padding for labels
//           child: Container(
...
//           text: getFormattedDate(data.bars[i].date, xLabelConfiguration!.showDay, xLabelConfiguration!.showMonth, xLabelConfiguration!.showYear),
...
//     else if(showDay && showMonth)
//       return "${(date.day<10)?'0${date.day}':'${date.day}'}\n$month";
//     else if(showDay && showYear)
//       return "${(date.day<10)?'0${date.day}':'${date.day}'}\n${date.year}";
